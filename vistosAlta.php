...
<html lang="es">
  ...
  <body>
    <div class="container">      
        ...
        <div class="row">
            <div class="col-xs-12">
                <h4 class="well well-sm text-center"><b>VISTOS ALTAS</b></h4>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <input type="hidden" name="valt_id" id="valt_id" value="" />
                        
                        <div class="form-group">
                            <label for="valt_descripcion" class="control-label col-md-2 col-md-offset-1">Descripci&oacute;n:</label>
                            <div class="col-md-9">
                                <input type="text" name="valt_descripcion" id="valt_descripcion" class="form-control input-sm" required minlength="10" maxlength="255" placeholder="Descripci&oacute;n" title="Descripci&oacute;n"/>
                            </div>                
                        </div> 
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">                    
                        ...
                        <input type="hidden" name="valt_id" id="delete_valt_id" value="" />
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-cancelar" data-dismiss="modal">Cancelar</button>
    ...
    var listar = function(){        
        var table = $("#dtVistos").DataTable({            
            ...
            "ajax":{
                method: "GET",
                url: "crudVistosAlta.php?opcion=leer"
            },
            "columnDefs":[
                {
                 targets: [0],
    ...
    $('#modalCrearEditar').on('shown.bs.modal', function(){
        if( ! $("#valt_descripcion").prop("readonly") ){
            $('#valt_descripcion').focus();
        }else{
            $("#valt_descripcion").focus();
        }
    });
    ...
    var obtener_datos = function(tbody, table){
        $(tbody).on("click", "button.editar", function(){            
            ...
            $("#valt_id").val( data.valt_id );
            $("#valt_descripcion").val( data.valt_descripcion);              
        });        
    }
    ...
    var obtener_id = function(tbody, table){
        $(tbody).on("click", "button.eliminar", function(){
            var data = table.row( $(this).parents("tr") ).data();
            var valt_id = $("#delete_valt_id").val( data.valt_id ),
            valt_descripcion = $("#registro").text( data.valt_descripcion );
        });        
    }
