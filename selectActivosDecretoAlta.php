...
<html lang="es">
  <head>
    <title>Activos - Decretos de Alta</title>
  ...
  <body>
    <div class="container">      
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="well well-sm text-center"><b>ACTIVOS - DECRETOS DE ALTA</b></h4>
            </div>
        </div>
    ...
    var listar = function(){
        var table = $("#dtActivos").DataTable({            
            ...
            "ajax":{                
                url: "crudSelectActivosDecretoAlta.php",
                type: "POST"
            },
            "deferRender": true,
            "columnDefs":[
            ...
            "buttons":[
                ...
                },                
                {
                    ...
                    "className": "btn btn-success",
                    "action": function(){
                        parametros('datosDecretoAltas.php');
                ...
                },
                {
                    ...
                    "action": function(){
                        parametros('distribucionAlta.php');
    ...
    function popup(opc, json, table){
        ...
        var url = 'decretoAlta.php?opc='+opc+'&'+queryString;
        //alert(url);
        if( opc == 'preview' ){        
