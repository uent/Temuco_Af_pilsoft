...
<html lang="es">
  <head>
    <title>Activos - Decretos de Reincorporaci&oacute;n</title>
  ...
  <body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="well well-sm text-center"><b>ACTIVOS - DECRETOS DE REINCORPORACI&Oacute;N</b></h4>
            </div>
        </div>
    ...
    var listar = function(){
        var table = $("#dtActivos").DataTable({
            ...
            "ajax":{
                url: "crudSelectActivosDecretoReincorporacion.php",
                type: "POST"
            },
            "deferRender": true,
            "columnDefs":[
            ...
            "buttons":[
                ...
                {
                    "text": "Generar Decreto de Reincorporación",
                ...
                },
                {
                    ...
                    "action": function(){
                        parametros('datosDecretoReincorporacion.php');

                    }
                },
                {
                    "text": "<span class='glyphicon glyphicon-pencil'></span>",
                    "titleAttr": "Vistos de Reincorporación",
                    "className": "btn btn-default",
                    "action": function(){
                        parametros('vistosReincorporacion.php');

                    }
                },
                {
                    "text": "<span class='glyphicon glyphicon-pencil'></span>",
                    "titleAttr": "Distribución de Reincorporación",
                    "className": "btn btn-warning",
                    "action": function(){
                        parametros('distribucionReincorporacion.php');
    ...
    function popup(opc, json, table){
        ...
        var url = 'decretoReincorporacion.php?opc='+opc+'&'+queryString;
        //alert(url);
        if( opc == 'preview' ){
    ...
    function parametros(mantenedor){
        var w = window.open(mantenedor, 'Parametros de Reincorporación', 'width='+screen.width+', height='+screen.height+', scrollbars=yes');
        w.moveTo(0, 0);
        w.focus();
    }
</script>
